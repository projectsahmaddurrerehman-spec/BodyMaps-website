...
# Keep the production Linux default, while allowing local Windows/macOS setups
# to choose a writable directory through flask-server/.env.
CHUNK_DIR = os.getenv("BODYMAPS_UPLOAD_CHUNK_DIR", "/tmp/uploads")
